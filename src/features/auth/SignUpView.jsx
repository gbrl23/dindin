        ...
        <div style={{
            ...
            <div className="card animate-scale-in" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', margin: '24px 0' }}>
                    ...
                    <span style={{ margin: '0 16px', color: 'var(--text-secondary)', fontSize: '0.9rem', fontWeight: '500' }}>ou crie com email</span>
                    <div style={{ flex: 1, borderTop: '1px solid var(--border)' }}></div>
                </div>

                <form id="signup-form" onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div>
